 ...
 */
public class MeasurementAttributeUserType implements UserType {
  @Override
  public int[] sqlTypes() {
  ...
  public Class returnedClass() {
    return MeasurementAttribute.class;
  }
  ...
  public Object nullSafeGet(ResultSet resultSet, String[] names, SessionImplementor session, Object owner) throws SQLException {
    ...
    return resultSet.wasNull() ? null : MeasurementAttribute.fromString(name);
  }
