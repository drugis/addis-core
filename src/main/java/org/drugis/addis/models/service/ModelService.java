...
public interface ModelService {
  public Model createModel(Integer analysisId, ModelCommand modelCommand) throws ResourceDoesNotExistException, InvalidModelTypeException, InvalidHeterogeneityTypeException;
