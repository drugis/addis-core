...
public class ContrastDichotomousOddsProblemEntry extends AbstractContrastDataEntry {
  private final Double meanDifference;

  public ContrastDichotomousOddsProblemEntry(String studyName, Integer treatmentId, Double meanDifference, Double stdErr) {
  ...
  public boolean equals(Object o) {
    ...
    ContrastDichotomousOddsProblemEntry that = (ContrastDichotomousOddsProblemEntry) o;
