...
public class ProblemController extends AbstractAddisCoreController {
  ...
  @ResponseBody
  public AbstractProblem get(@PathVariable Integer projectId, @PathVariable Integer analysisId) throws ResourceDoesNotExistException, URISyntaxException, SQLException, IOException, ReadValueException {
