...
public class InterventionRepositoryImpl implements org.drugis.addis.interventions.repository.InterventionRepository {
  ...
  @Override
  public AbstractIntervention create(Account user, AbstractInterventionCommand interventionCommand) throws MethodNotAllowedException, ResourceDoesNotExistException {
