...
define([
  ...
  "./home/home",
], function (angular, Config, mcdaLexicon, gemtcLexicon) {
  ...
  var app = angular.module(
    ...
    dependencies.concat(
      mcdaDependencies,
      gemtcWebDependencies,
      trialverseDependencies
    )
  );

    app.constant('Tasks', Config.tasks);
    app.constant('DEFAULT_VIEW', 'evidence');
    app.constant('currentSchemaVersion', '1.4.4');
  ...
  app.run([
    ...
    function (
      ...
      $templateCache.put(
        ...
        require("./studyInformation/studyInformation.html")
      );
      $templateCache.put(
        "populationInformation.html",
        require("./populationInformation/populationInformation.html")
      );
      ...
      $templateCache.put(
        "measurementMoment.html",
        require("./measurementMoment/measurementMoment.html")
      );
      $templateCache.put("activity.html", require("./activity/activity.html"));
      $templateCache.put(
        "activityDosingPeriodicityDirective.html",
        require("./activity/activityDosingPeriodicityDirective.html")
      );
      $templateCache.put(
        "interventionDosingPeriodicityDirective.html",
        require("./intervention/interventionDosingPeriodicityDirective.html")
      );
      $templateCache.put(
        "durationInputDirective.html",
        require("./util/directives/durationInput/durationInputDirective.html")
      );
      ...
      PageTitleService.loadLexicon(
        $q.resolve(require("mcda-web/app/mcda-page-titles.json"))
      );
      PageTitleService.loadLexicon(
        $q.resolve(require("gemtc-web/app/gemtc-page-titles.json"))
      );
      PageTitleService.loadLexicon(
        $q.resolve(require("../../addis-page-titles.json"))
      );

      $transitions.onSuccess({}, function (transition) {
        var redirectUrl = $cookies.get("returnToPage");
        if (
          transition.to().name === "datasets" &&
      ...
      $templateCache.put(
        "model-settings-section.html",
        require("gemtc-web/views/model-settings-section.html")
      );
      $templateCache.put(
        "convergence-diagnostics-section.html",
        require("gemtc-web/views/convergence-diagnostics-section.html")
      );
      $templateCache.put(
        "meta-regression-section.html",
        require("gemtc-web/views/meta-regression-section.html")
      );
      $templateCache.put(
        "results-section.html",
        require("gemtc-web/views/results-section.html")
      );
      $templateCache.put(
        "model-fit-section.html",
        require("gemtc-web/views/model-fit-section.html")
      );
    },
  ]);
    ...
    function (
      ...
      $stateProvider
        ...
        .state("createModel", {
          ...
          url:
            "/users/:userUid/projects/:projectId/nma/:analysisId/models/createModel",
        ...
        .state("refineModel", {
          parent: "nmaModelContainer",
          url:
            "/users/:userUid/projects/:projectId/nma/:analysisId/models/:modelId/refineModel",
          templateUrl: "gemtc-web/js/models/createModel.html",
          controller: "CreateModelController",
          resolve: {
            model: [
        ...
        .state("model", {
          url:
            "/users/:userUid/projects/:projectId/nma/:analysisId/models/:modelId",
          parent: "nmaModelContainer",
        ...
        .state("studyHistory", {
          url:
            "/users/:userUid/datasets/:datasetUuid/studies/:studyGraphUuid/history",
