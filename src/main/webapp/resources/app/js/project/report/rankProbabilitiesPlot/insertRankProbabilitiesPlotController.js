...
define(['lodash'], function(_) {
  ...
  var InsertRankProbabilitiesTableController = function($scope, $stateParams, $modalInstance, $q,
    ReportDirectiveService, callback, CacheService) {
    ...
    $scope.insertRankProbabilitiesPlot = insertRankProbabilitiesPlot;
    ...
    function insertRankProbabilitiesPlot() {
      callback(ReportDirectiveService.getDirectiveBuilder('rank-probabilities-plot')($scope.selections.analysis.id,
