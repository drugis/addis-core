...
public class ProjectServiceTest {
  ...
  public void createUpdated() throws Exception, ReadValueException, ProblemCreationException {
    ...
    when(problemService.getProblem(newProjectId, newNma1.getId(), null)).thenReturn(newProblem1);
    when(problemService.getProblem(projectId, nma1.getId(), null)).thenReturn(oldProblem1);
    ...
    verify(problemService, times(2)).getProblem(newProjectId, newNma1.getId(), null);
    verify(problemService, times(2)).getProblem(projectId, nma1.getId(), null);
