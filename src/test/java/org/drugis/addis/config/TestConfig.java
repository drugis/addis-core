...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"org.drugis.addis.config", "org.drugis.addis.error", "org.drugis.addis.projects.controller",
        "org.drugis.addis.trialverse"}, excludeFilters = {@ComponentScan.Filter(Configuration.class)})
