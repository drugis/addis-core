...
CREATE TABLE FixedDoseIntervention (id SERIAL NOT NULL,
                           ...
                           lowerBoundUnit varchar,
                           upperBoundType varchar,
                           upperBoundValue double,
                           upperBoundUnit varchar,
  PRIMARY KEY (id),
  FOREIGN KEY(project) REFERENCES Project(id));
...
CREATE TABLE TitratedDoseIntervention (id SERIAL NOT NULL,
                           ...
                           minLowerBoundUnit varchar,
                           minLowerBoundValue double,
                           minUpperBoundType varchar,
                           minUpperBoundUnit varchar,
                           minUpperBoundValue double,
                           maxLowerBoundType varchar,
                           maxLowerBoundUnit varchar,
                           maxLowerBoundValue double,
                           maxUpperBoundType varchar,
                           maxUpperBoundUnit varchar,
                           maxUpperBoundValue double,
  PRIMARY KEY (id),
  FOREIGN KEY(project) REFERENCES Project(id));
