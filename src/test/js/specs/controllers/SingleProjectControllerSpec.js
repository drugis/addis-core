define(['angular', 'angular-mocks', 'underscore'], function () {
  describe('SingleProjectController', function () {
    ...
    it("should make an update call when an analysis is added", function() {
      var newAnalysis = {name: "name", type: "SingleStudyBenefitRisk", study: "Hansen et al. 2005"};
      var newAnalysisWithProjectId = _.extend(newAnalysis, {projectId: 1});
      ...
      scope.$apply();
      expect(state.go).toHaveBeenCalledWith('analysis', {projectId: mockAnalysis.projectId, analysisId: mockAnalysis.id});
    });
