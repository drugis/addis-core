define(['angular', 'angular-mocks', 'filters'], function () {
  describe("Filter: ownProjectsFilter", function () {
    ...
    it("should deal gracefully with unresolved promises", function() {
      mockProjects.$resolved = false;
      expect(ownProjectsFilter(mockProjects, 1).length).toEqual(0);
    });
